		...
		2023: [
			{
				icon: faMedal,
				title: "3rd place",
				subtitle: "Math competition at high school level",
				date: "Jan 2023",
		...
		2021: [
			{
				icon: faMedal,
				title: "3rd place",
				subtitle: "Math competition at junior high school level",
				date: "Nov 2021",
				color: "from-amber-600 to-yellow-600",
			},
			{
						...
						<div>
							...
							<div className="flex items-center gap-2">
								<p className="text-gray-600 text-justify title text-lg">
									...
									<span className="text-black font-medium"> professional Software Engineer</span>,
									I am currently pursuing my Bachelor’s degree at
									<span className="text-black font-medium"> Hanoi University of Science and Technology</span>.
									My journey in technology is fueled by curiosity and creativity—blending
									<span className="text-black font-medium"> web development</span>
									with research and implementation of
									<span className="text-black font-medium"> advanced AI</span>.
									<br />
									<br />
									I am passionate about solving real-world problems through code, especially at the intersection
									of <span className="text-black font-medium"> Web Development</span> and
									<span className="text-black font-medium"> Artificial Intelligence</span>.
									My focus is on building modern, scalable, and flexible web applications, while exploring how AI—
									from traditional machine learning models to large language systems—can be integrated to create
									smarter user experiences. My enthusiasm lies not only in technical aspects, but also in connecting
									technology with human needs, transforming ideas into valuable and practical products.
									<br />
									<br />
									Constantly learning, building, and collaborating—I am excited to continue growing and contributing
